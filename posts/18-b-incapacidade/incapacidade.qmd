...
description: Benefícios do RGPS que se destinam a cobrir o risco de incapacidade para o trabalho.
date: "2023-10-03"
author: 
  - name: "Igor MENDONÇA"
draft: false
...
[^1]: V. Portaria Interministerial MTP/MS n.º 22, de 31 de agosto de 2022.
...
rankdir=LR;
  ...
  "requisitos" -> "incapacidade total e permanente";
  "incapacidade total e permanente" -> "ou parcial: condições pessoais/sociais";
  "incapacidade total e permanente" -> "ou parcial: doenças estigmatizantes";
  "requisitos" -> "qualidade de segurado na DII";
  "requisitos" -> "carência de 12 meses"
  "carência de 12 meses" -> "exceções";
  "exceções" -> "acidentes";
  "exceções" -> "doenças graves";
  "Aposentadoria por invalidez" -> "avaliação/reavaliação";
  "avaliação/reavaliação" -> "perícia médica";
  "avaliação/reavaliação" -> "obrigatória";
  "obrigatória" -> "salvo";
  "salvo" -> "60 anos";
  "salvo" -> "55 anos + 15 anos de benefício";
  "salvo" -> "HIV";
  "Aposentadoria por invalidez" -> "DII";
  "DII" -> "empregado";
  "empregado" -> "DIB = DII + 15 (se DER até 30 dias)";
  "empregado" -> "DIB = DER (se DER > 30 dias)";
  "DII" -> "demais segurados";
  "demais segurados" -> "DIB = DII (se DER até 30 dias)";
  "demais segurados" -> "DIB = DER (se DER > 30 dias)";
  "Aposentadoria por invalidez" -> "RMI";
  "RMI" -> "60% do SB (exceto acidente de trabalho = 100%)";
  "Aposentadoria por invalidez" -> "auxílio-acompanhante";
  "auxílio-acompanhante" -> "25%";
  "Aposentadoria por invalidez" -> "DCB";
  "DCB" -> "recuperação integral em até 5 anos";
  "recuperação integral em até 5 anos" -> "empregado que retorna: cessação imediata";
  "recuperação integral em até 5 anos" -> "demais segurados: prorrogação*";
  "DCB" -> "recuperação parcial ou > 5 anos";
  "recuperação parcial ou > 5 anos" -> "mensalidades de recuperação**";
}
```
...
### Exercício de atividade laborativa pelo segurado incapaz
...
rankdir=LR;
  ...
  "requisitos" -> "incapacidade temporária";
  "requisitos" -> "qualidade de segurado na DII";
  "requisitos" -> "carência de 12 meses"
  "carência de 12 meses" -> "exceções";
  "exceções" -> "acidentes";
  "exceções" -> "doenças graves";
  "Auxílio-doença" -> "avaliação/reavaliação";
  "avaliação/reavaliação" -> "perícia médica";
  "avaliação/reavaliação" -> "obrigatória";
  "Auxílio-doença" -> "DII";
  "DII" -> "empregado";
  ...
  "RMI" -> "91% do SB";
  "Auxílio-doença" -> "DCB";
  "DCB" -> "pré-fixada, salvo prorrogação";
  "DCB" -> "se não fixada, 120 dias";
  "DCB" -> "recuperação da capacidade";
  "DCB" -> "incapacidade total e permanente";
  "DCB" -> "retorno voluntário";
}
```
...
[^3]: Lei 8.213/91. Art. 15. Mantém a qualidade de segurado, independentemente de contribuições: I - sem limite de prazo, quem está em gozo de benefício, exceto do auxílio-acidente;
